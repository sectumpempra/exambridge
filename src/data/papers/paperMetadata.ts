...
// The award route requires P1-P4 plus two eligible applied units; the second
// applied unit is selected by the learner on the calculator/planner page.
const EDEXCEL_IAL_MATH_PAPERS: PaperMetadata[] = [
...
].map(([number, name, unitCode]) => ({
  paperId: `EDX-WMA-${number}`,
  board: "Edexcel",
  qualification: "A-Level",
  subjectCode: "WMA",
  subjectName: "International A-Level Mathematics",
  paperNumber: number,
  paperName: name,
  duration: "1h 30m",
  durationMinutes: 90,
