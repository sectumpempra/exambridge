...
import aqaData from "../../data/aqa.json";
...
export default function AqaPage() {
  return (
    <BoardPage
      boardName="AQA"
      note="数据来源于 AQA 官方，仅作学习参考。含 GCSE Mathematics (8300)、Level 2 Further Mathematics (8365)、Biology (8461)、Chemistry (8462)、Physics (8463)、English Language (8700)、English Literature (8702)。版权归 AQA 所有。"
      columns={COLUMNS}
      data={aqaData as Record<string, string | number>[]}
      gradeFields={GRADES}
      codeField="code"
