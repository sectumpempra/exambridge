...
export default function GradeCalculator() {
  ...
  const qualificationChoices = useMemo(() => {
    const supported = new Set(["AQA:7357", "OCR:H240", "OCR:6993", "CAIE:9709", "Edexcel UK:8MA0"]);
  ...
  const awardQualification = awardCourseCandidate && ["AQA:7357", "OCR:H240", "OCR:6993", "CAIE:9709", "Edexcel UK:8MA0"].includes(`${awardCourseCandidate.boardName}:${awardCourseCandidate.subjectCode}`) && awardCourseCandidate.gradeCalculation.status !== "unavailable"
