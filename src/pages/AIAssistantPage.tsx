    ...
    <main className="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 sm:py-7">
      <section className="grid gap-4 lg:grid-cols-[minmax(250px,0.46fr)_minmax(0,1.54fr)] lg:items-stretch">
        <div className="rounded-[26px] border border-[#ccd4d4] bg-[linear-gradient(145deg,#fdfcf9,#edf3f1)] p-5 shadow-[0_20px_55px_rgba(61,56,50,0.07)]">
          ...
          <h1 className="mb-0 mt-1.5 text-2xl font-bold tracking-tight">全站考试事实查询</h1>
          <p className="mb-0 mt-3 text-xs leading-6 text-[#625c54]">直接询问考试结构、Paper 规则、合分、分数线或多个资格的差异。课程筛选不是必填项，助手只使用当前已批准的数据。</p>
          ...
          <div className="mt-4 rounded-xl bg-[#253b46] px-3 py-3 text-[11px] leading-5 text-[#dbe6e7]"><Sparkles size={14} className="mb-1.5" />可以不选课程直接提问；选择课程只用于限定检索范围。问题中明确写出的资格始终优先。</div>
        </div>
        {enabled ? <AIChatPanel
          fullHeight
