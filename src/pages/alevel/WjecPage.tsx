...
export default function AlevelWjecPage() {
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      <Header title="WJEC / Eduqas" />

      <main className="max-w-[1200px] mx-auto px-5 pt-[88px] pb-20">
        {/* Breadcrumb */}
        <nav className="text-sm text-[#625C54] mb-6">
        ...
        <div className="text-center py-16">
          <div
            ...
            style={{ background: "linear-gradient(135deg, #5A7080 0%, #52697A 100%)" }}
          >
          ...
          <p className="text-lg text-[#625C54] max-w-2xl mx-auto mb-4">
            威尔士 WJEC 与英格兰 Eduqas 的 A-Level 分数线数据
          </p>

          <p className="text-sm text-[#6E675E] max-w-xl mx-auto mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mt-8">
          <div className="bg-white rounded-xl p-5 border border-[#E8E4DE]">
            ...
            <p className="text-sm text-[#625C54]">
