...
await writeFile(path.join(outDir, "README.txt"), [
  ...
  "Optional environment: AI_HOST, AI_PORT, AI_ALLOWED_ORIGINS, AI_PROVIDER_TIMEOUT_MS, AI_PROVIDER_MAX_OUTPUT_TOKENS_LOW, AI_PROVIDER_MAX_OUTPUT_TOKENS_MAX, AI_DAILY_REQUEST_LIMIT, AI_DAILY_TOKEN_LIMIT, AI_PROVIDER_FAILURE_THRESHOLD, AI_PROVIDER_COOLDOWN_MS, EXAMBRIDGE_DATA_ROOT",
